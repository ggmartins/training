...
- [1. Introduction](#1-introduction)
  - [1.1 The Role of DevOps](#11-the-role-of-devops)
  - [1.2 Tools](#12-tools)
  - [1.2.1 Tools on stages:](#121-tools-on-stages)
  - [1.3 DevOps Principles](#13-devops-principles)
    - [1.3.1 Configuration Management](#131-configuration-management)
  - [1.4 DevOps WorkFlow](#14-devops-workflow)
- [2. Azure Fundamentals](#2-azure-fundamentals)
  - [2.1 IaaS vs PaaS](#21-iaas-vs-paas)
  - [2.2 Resource Groups (RGs)](#22-resource-groups-rgs)
    - [2.2.1 Management Groups: A management group is a container for subscriptions. Exist under the heading of](#221-management-groups-a-management-group-is-a-container-for-subscriptions-exist-under-the-heading-of)
    - [2.2.2 Subscriptions: A subscription is a container for resources. Often assigned to businesses or](#222-subscriptions-a-subscription-is-a-container-for-resources-often-assigned-to-businesses-or)
    - [2.2.3 Resource Groups: Often resouce groups can exist for a single app or a single project.](#223-resource-groups-often-resouce-groups-can-exist-for-a-single-app-or-a-single-project)
  - [2.3 IaaS](#23-iaas)
    - [2.3.1 Storage Accounts and Blob Storage](#231-storage-accounts-and-blob-storage)
      - [2.3.1.1 Blob Storage](#2311-blob-storage)
      - [2.3.1.2 SQL Servers](#2312-sql-servers)
    - [2.3.2 VMs](#232-vms)
    - [2.3.3 Networking](#233-networking)
      - [2.3.3.1 Subnetting](#2331-subnetting)
      - [2.3.3.2 NIC](#2332-nic)
      - [2.3.3.3 Network Security Group (NSG)](#2333-network-security-group-nsg)
      - [2.3.3.4 Load Balancer (L4 Network LB)](#2334-load-balancer-l4-network-lb)
      - [2.3.3.5 Application Load Balancer (L7 Application LB)](#2335-application-load-balancer-l7-application-lb)
      - [2.3.3.6 Connection VNETs via VNET peering](#2336-connection-vnets-via-vnet-peering)
        - [2.3.3.6.1 Connecting to On-Prem](#23361-connecting-to-on-prem)
    - [2.3.4 Azure Monitor](#234-azure-monitor)
    - [2.3.5 Active Directory (Entra ID)](#235-active-directory-entra-id)
      - [2.3.5.1 Service Principal](#2351-service-principal)
- [3. Azure DevOps Intro](#3-azure-devops-intro)
  - [3.1 General Tips](#31-general-tips)
  - [3.2 azure-pipelines.yaml](#32-azure-pipelinesyaml)
- [](#)
  - [3.3 Azure Vault, Secrets and Managed Identities](#33-azure-vault-secrets-and-managed-identities)
    - [3.3.1 Secrets](#331-secrets)
    - [3.3.2 Managed Identities](#332-managed-identities)
      - [3.3.2.1 System-Assigned Managed Identity](#3321-system-assigned-managed-identity)
      - [3.3.2.2 User-Assigned Managed Identity](#3322-user-assigned-managed-identity)
    - [3.3.3 Azure Key Vault](#333-azure-key-vault)
      - [3.3.3.1 Secrets](#3331-secrets)
      - [3.3.3.2 Keys](#3332-keys)
      - [3.3.3.3 Secrets](#3333-secrets)
- [4. Azure Artefacts](#4-azure-artefacts)
- [5. Pipeline Stages](#5-pipeline-stages)
- [5.1 Pipeline Templates](#51-pipeline-templates)
- [5.2 Environments](#52-environments)
- [5.3 Releases](#53-releases)
- [5.4 Agent Pools](#54-agent-pools)
- [5.5 Service Connections](#55-service-connections)
- [6. Azure Compute (az-204)](#6-azure-compute-az-204)
  - [6.1 Containerized Solutions (az-204)](#61-containerized-solutions-az-204)
    - [6.1.1 Creating and Managing Container Images for Solutions](#611-creating-and-managing-container-images-for-solutions)
      - [6.1.1.1 Container](#6111-container)
      - [6.1.1.2 ACR Azure Container Registry](#6112-acr-azure-container-registry)
    - [6.1.2 Publishing an Image to ACR Azure Container Registry](#612-publishing-an-image-to-acr-azure-container-registry)
    - [6.1.3 Running Containers with ACI Azure Container Instances](#613-running-containers-with-aci-azure-container-instances)
      - [6.1.3.1 Container Groups](#6131-container-groups)
    - [6.1.4 Running Containers with ACA Azure Container Apps](#614-running-containers-with-aca-azure-container-apps)
    - [6.1.5 ACI vs ACA](#615-aci-vs-aca)
  - [6.2 Azure App Service Web Apps (az-204)](#62-azure-app-service-web-apps-az-204)
  - [6.3 Azure Functions (az-204)](#63-azure-functions-az-204)
- [7. Azure CosmosDB (az-204)](#7-azure-cosmosdb-az-204)
- [8. Blob Storage (az-204)](#8-blob-storage-az-204)
- [9. Azure Security (az-204)](#9-azure-security-az-204)
- [10. Fabric](#10-fabric)
  - [10.1 Fabric Capacity](#101-fabric-capacity)
    - [10.1.1 Workspace within Fabric Capacity](#1011-workspace-within-fabric-capacity)
    - [10.1.2 Azure Data Lake Storage Account (ADLSGen2)](#1012-azure-data-lake-storage-account-adlsgen2)
      - [10.1.2.1 ADLSGen2 API SDK](#10121-adlsgen2-api-sdk)
    - [10.1.3 Delta Tables Parquet Files](#1013-delta-tables-parquet-files)
      - [10.1.3.1 Delta Lake V-Ordering](#10131-delta-lake-v-ordering)
      - [10.1.3.2 Delta Lake Z-Ordering](#10132-delta-lake-z-ordering)
    - [10.1.4 Iceberg format](#1014-iceberg-format)
    - [10.1.5 Mirror and Caching](#1015-mirror-and-caching)
    - [10.1.6 Dataflow Gen2](#1016-dataflow-gen2)
    - [10.1.7 Task Flow](#1017-task-flow)
    - [10.2 Item examples](#102-item-examples)
