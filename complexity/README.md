...
- [1. Complexity Measurements](#1-complexity-measurements)
  - [1.1 Time Complexity](#11-time-complexity)
  - [1.2 Space Complexity](#12-space-complexity)
  - [1.3 Other Less Common Complexity Measurements](#13-other-less-common-complexity-measurements)
    - [1.3.1 I/O Complexity](#131-io-complexity)
    - [1.3.2 Communication Complexity](#132-communication-complexity)
    - [1.3.3 Query Complexity](#133-query-complexity)
    - [1.3.4 Parallel Computation (Work / Span)](#134-parallel-computation-work--span)
    - [1.3.5 Circuit Size and Circuit Depth](#135-circuit-size-and-circuit-depth)
- [2. Asymptotic Bounding](#2-asymptotic-bounding)
  - [2.1 References](#21-references)
- [3. Big-O Complexity](#3-big-o-complexity)
  - [3.1 O(1)](#31-o1)
  - [3.2 O(log n)](#32-olog-n)
  - [3.3 O(n)](#33-on)
  - [3.4 O(n log(n))](#34-on-logn)
  - [3.5 O(n^2)](#35-on2)
  - [3.6 O(2^n)](#36-o2n)
  - [3.7 O(n!)](#37-on)
- [4. Little-o](#4-little-o)
- [5. DSAs and their asymptotic complexity](#5-dsas-and-their-asymptotic-complexity)
  - [5.1 Data Structure Complexity](#51-data-structure-complexity)
  - [5.2 Sorting Algorithm Complexity](#52-sorting-algorithm-complexity)
    - [Notes](#notes)
